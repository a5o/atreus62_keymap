...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_TRNS, X(AGRV), KC_TRNS, X(DEGREE), KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_TRNS, X(ALM),
	KC_TRNS, KC_TRNS, KC_TRNS, X(COPY), KC_TRNS, KC_TRNS, KC_INS, X(MICRO), X(LTEQ), X(GTEQ), KC_TRNS, KC_BSLS,
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP, KC_END
	),
