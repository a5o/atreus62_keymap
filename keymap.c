...
[_BASE] = LAYOUT( /* qwerty */
    ...
    MO(_FUN),      KC_LCTL,   KC_LALT, KC_LGUI,LOWER,  KC_BSPC, KC_DEL,   KC_SPC,   KC_GRV,  RAISE,  KC_LBRC, KC_RBRC , KC_PGUP , KC_PGDN
  ),



  [_LOWER] = LAYOUT(
    KC_PIPE,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                     KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS ,
    KC_TRNS,  KC_TRNS, KC_TRNS, IT_EGRV, KC_TRNS, KC_TRNS,                     KC_TRNS, IT_UGRV, IT_IGRV, IT_OGRV, KC_TRNS, KC_PLUS ,
    KC_TRNS,  IT_AGRV, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DQT ,
